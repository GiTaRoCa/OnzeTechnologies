...
Changes of the data of more information and description of section   
*******************************************************************/

var titles=["Transformación Digital","Cloud Computing","Big Data - Analítica","Movilidad","Oficinas y Casas Inteligentes","Seguridad Informática","Soluciones de Gestión Empresarial","Soluciones Retail – Hardware y Software","Hardware – Software - Licenciamiento","Redes Eléctricas y Comunicaciones","Gestión del Cambio"];
...
var onloadCallback = function () {
  ...
  'sitekey': '6LePKFIUAAAAANYVMz0t58IWadWgsHoOvhTYAIez',
...
objectCont=myObj.blocks[section].container;
...
//Function clean Modal 
function CleanModal(){
$('.modal-body').html("<div></div>");	
}
//Function link 
function SendAnchor(link){
  setTimeout(function (){window.location.assign(link);},800);   
};
//Function validate form 
function ValidateForm(e,id){
formMessage=document.getElementById(id);
...
xhttp.open("POST", "server/php/sw_email.php", true);
